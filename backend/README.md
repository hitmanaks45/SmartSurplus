# 🍽️ SmartSurplus — Backend API

A RESTful backend API for **SmartSurplus**, a platform that connects food donors with receivers to reduce food waste. Built with **Node.js**, **Express**, and **MongoDB**.
...
git clone https://github.com/sahilgupta088/SmartSurplus-Backend.git
cd SmartSurplus-Backend
